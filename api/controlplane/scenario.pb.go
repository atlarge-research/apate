...
type Task struct {
	...
	//	*Task_NodeLifecycleState
	//	*Task_ResourcePressure
	//	*Task_PodLifecycleState
...
func (x *Task) GetNodeLifecycleState() *events.LifecycleState {
	if x, ok := x.GetEvent().(*Task_NodeLifecycleState); ok {
...
func (x *Task) GetPodLifecycleState() *events.LifecycleState {
	if x, ok := x.GetEvent().(*Task_PodLifecycleState); ok {
...
type Task_NodeLifecycleState struct {
	NodeLifecycleState *events.LifecycleState `protobuf:"bytes,9,opt,name=node_lifecycle_state,json=nodeLifecycleState,proto3,oneof"`
}
...
type Task_PodLifecycleState struct {
	// Pod events
	PodLifecycleState *events.LifecycleState `protobuf:"bytes,11,opt,name=pod_lifecycle_state,json=podLifecycleState,proto3,oneof"`
}
...
func (*Task_NodeLifecycleState) isTask_Event() {}

func (*Task_ResourcePressure) isTask_Event() {}

func (*Task_PodLifecycleState) isTask_Event() {}
...
var file_controlplane_scenario_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x74, 0x61, 0x73, 0x6b, 0x73, 0x22, 0xfd, 0x06, 0x0a, 0x04, 0x54, 0x61, 0x73, 0x6b,
	...
	,
	...
	0x65, 0x12, 0x5b, 0x0a, 0x15, 0x70, 0x6f, 0x64, 0x5f, 0x73, 0x74, 0x61, 0x72, 0x74, 0x5f, 0x74,
	0x69, 0x6d, 0x65, 0x5f, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x26, 0x2e, 0x61, 0x70, 0x61, 0x74, 0x65, 0x2e, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c,
	0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2e, 0x50, 0x6f, 0x64, 0x53, 0x74, 0x61, 0x72, 0x74, 0x54, 0x69,
	0x6d, 0x65, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x48, 0x00, 0x52, 0x12, 0x70, 0x6f, 0x64, 0x53,
	0x74, 0x61, 0x72, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x42, 0x07,
	0x0a, 0x05, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x22, 0x68, 0x0a, 0x04, 0x4e, 0x6f, 0x64, 0x65, 0x12,
	...
	0x03, 0x52, 0x03, 0x63, 0x70, 0x75, 0x12, 0x19, 0x0a, 0x08, 0x6d, 0x61, 0x78, 0x5f, 0x70, 0x6f,
	0x64, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x6d, 0x61, 0x78, 0x50, 0x6f, 0x64,
	0x73, 0x22, 0x5f, 0x0a, 0x09, 0x4e, 0x6f, 0x64, 0x65, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x12, 0x1d,
	...
	0x52, 0x08, 0x6e, 0x6f, 0x64, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x6d,
	0x6f, 0x75, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75,
	0x6e, 0x74, 0x32, 0x9b, 0x01, 0x0a, 0x08, 0x53, 0x63, 0x65, 0x6e, 0x61, 0x72, 0x69, 0x6f, 0x12,
	0x4c, 0x0a, 0x0c, 0x6c, 0x6f, 0x61, 0x64, 0x53, 0x63, 0x65, 0x6e, 0x61, 0x72, 0x69, 0x6f, 0x12,
	0x22, 0x2e, 0x61, 0x70, 0x61, 0x74, 0x65, 0x2e, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x70,
	0x6c, 0x61, 0x6e, 0x65, 0x2e, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x53, 0x63, 0x65, 0x6e, 0x61,
	...
	0x0d, 0x73, 0x74, 0x61, 0x72, 0x74, 0x53, 0x63, 0x65, 0x6e, 0x61, 0x72, 0x69, 0x6f, 0x12, 0x16,
...
var file_controlplane_scenario_proto_goTypes = []interface{}{
	...
	(*events.NetworkLatency)(nil),       // 5: apate.controlplane.NetworkLatency
	(*events.TimeoutKeepHeartbeat)(nil), // 6: apate.controlplane.TimeoutKeepHeartbeat
	(*events.NoTimeoutNoHeartbeat)(nil), // 7: apate.controlplane.NoTimeoutNoHeartbeat
	(*events.LifecycleState)(nil),       // 8: apate.controlplane.LifecycleState
	(*events.ResourcePressure)(nil),     // 9: apate.controlplane.ResourcePressure
	(*events.PodStatusUpdate)(nil),      // 10: apate.controlplane.PodStatusUpdate
	(*events.PodStartTimeUpdate)(nil),   // 11: apate.controlplane.PodStartTimeUpdate
...
var file_controlplane_scenario_proto_depIdxs = []int32{
	...
	5,  // 4: apate.controlplane.Task.network_latency:type_name -> apate.controlplane.NetworkLatency
	6,  // 5: apate.controlplane.Task.timeout_keep_heartbeat:type_name -> apate.controlplane.TimeoutKeepHeartbeat
	7,  // 6: apate.controlplane.Task.no_timeout_no_heartbeat:type_name -> apate.controlplane.NoTimeoutNoHeartbeat
	8,  // 7: apate.controlplane.Task.node_lifecycle_state:type_name -> apate.controlplane.LifecycleState
	9,  // 8: apate.controlplane.Task.resource_pressure:type_name -> apate.controlplane.ResourcePressure
	8,  // 9: apate.controlplane.Task.pod_lifecycle_state:type_name -> apate.controlplane.LifecycleState
	10, // 10: apate.controlplane.Task.pod_status_update:type_name -> apate.controlplane.PodStatusUpdate
	11, // 11: apate.controlplane.Task.pod_start_time_update:type_name -> apate.controlplane.PodStartTimeUpdate
...
func file_controlplane_scenario_proto_init() {
	...
	file_controlplane_scenario_proto_msgTypes[1].OneofWrappers = []interface{}{
		...
		(*Task_NodeLifecycleState)(nil),
		(*Task_ResourcePressure)(nil),
		(*Task_PodLifecycleState)(nil),
