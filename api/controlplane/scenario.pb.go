...
type Task struct {
	...
	//	*Task_NodeFailure
	//	*Task_NetworkSegregation
	//	*Task_NetworkLatency
	//	*Task_TimeoutKeepHeartbeat
	//	*Task_NoTimeoutNoHeartbeat
	//	*Task_NodeLifecycleTimeout
	//	*Task_NodeLifecycleError
	//	*Task_ResourcePressure
	//	*Task_PodLifecycleTimeout
	//	*Task_PodLifecycleError
...
func (x *Task) GetNetworkSegregation() *events.NetworkSegregation {
	if x, ok := x.GetEvent().(*Task_NetworkSegregation); ok {
		return x.NetworkSegregation
	}
	return nil
}
...
func (x *Task) GetNodeLifecycleTimeout() *events.LifecycleTimeout {
	if x, ok := x.GetEvent().(*Task_NodeLifecycleTimeout); ok {
		return x.NodeLifecycleTimeout
	}
	return nil
}

func (x *Task) GetNodeLifecycleError() *events.LifecycleErrorResponse {
	if x, ok := x.GetEvent().(*Task_NodeLifecycleError); ok {
		return x.NodeLifecycleError
	}
	return nil
}
...
func (x *Task) GetPodLifecycleTimeout() *events.LifecycleTimeout {
	if x, ok := x.GetEvent().(*Task_PodLifecycleTimeout); ok {
		return x.PodLifecycleTimeout
	}
	return nil
}

func (x *Task) GetPodLifecycleError() *events.LifecycleErrorResponse {
	if x, ok := x.GetEvent().(*Task_PodLifecycleError); ok {
		return x.PodLifecycleError
	}
	return nil
}
...
type Task_NetworkSegregation struct {
	NetworkSegregation *events.NetworkSegregation `protobuf:"bytes,6,opt,name=network_segregation,json=networkSegregation,proto3,oneof"`
}

type Task_NetworkLatency struct {
	NetworkLatency *events.NetworkLatency `protobuf:"bytes,7,opt,name=network_latency,json=networkLatency,proto3,oneof"`
}

type Task_TimeoutKeepHeartbeat struct {
	TimeoutKeepHeartbeat *events.TimeoutKeepHeartbeat `protobuf:"bytes,8,opt,name=timeout_keep_heartbeat,json=timeoutKeepHeartbeat,proto3,oneof"`
}

type Task_NoTimeoutNoHeartbeat struct {
	NoTimeoutNoHeartbeat *events.NoTimeoutNoHeartbeat `protobuf:"bytes,9,opt,name=no_timeout_no_heartbeat,json=noTimeoutNoHeartbeat,proto3,oneof"`
}

type Task_NodeLifecycleTimeout struct {
	NodeLifecycleTimeout *events.LifecycleTimeout `protobuf:"bytes,10,opt,name=node_lifecycle_timeout,json=nodeLifecycleTimeout,proto3,oneof"`
}

type Task_NodeLifecycleError struct {
	NodeLifecycleError *events.LifecycleErrorResponse `protobuf:"bytes,11,opt,name=node_lifecycle_error,json=nodeLifecycleError,proto3,oneof"`
}

type Task_ResourcePressure struct {
	ResourcePressure *events.ResourcePressure `protobuf:"bytes,12,opt,name=resource_pressure,json=resourcePressure,proto3,oneof"`
}

type Task_PodLifecycleTimeout struct {
	// Pod events
	PodLifecycleTimeout *events.LifecycleTimeout `protobuf:"bytes,13,opt,name=pod_lifecycle_timeout,json=podLifecycleTimeout,proto3,oneof"`
}

type Task_PodLifecycleError struct {
	PodLifecycleError *events.LifecycleErrorResponse `protobuf:"bytes,14,opt,name=pod_lifecycle_error,json=podLifecycleError,proto3,oneof"`
}

type Task_PodStatusUpdate struct {
	PodStatusUpdate *events.PodStatusUpdate `protobuf:"bytes,15,opt,name=pod_status_update,json=podStatusUpdate,proto3,oneof"`
}

type Task_PodStartTimeUpdate struct {
	PodStartTimeUpdate *events.PodStartTimeUpdate `protobuf:"bytes,16,opt,name=pod_start_time_update,json=podStartTimeUpdate,proto3,oneof"`
}

func (*Task_NodeFailure) isTask_Event() {}

func (*Task_NetworkSegregation) isTask_Event() {}
...
func (*Task_NodeLifecycleTimeout) isTask_Event() {}

func (*Task_NodeLifecycleError) isTask_Event() {}

func (*Task_ResourcePressure) isTask_Event() {}

func (*Task_PodLifecycleTimeout) isTask_Event() {}

func (*Task_PodLifecycleError) isTask_Event() {}
...
type Node struct {
	...
	MaxPods int64 `protobuf:"varint,4,opt,name=max_pods,json=maxPods,proto3" json:"max_pods,omitempty"`
}
...
var file_controlplane_scenario_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x74, 0x61, 0x73, 0x6b, 0x73, 0x22, 0xa2, 0x09, 0x0a, 0x04, 0x54, 0x61, 0x73, 0x6b,
	...
	,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x03, 0x63, 0x70, 0x75, 0x12, 0x19, 0x0a, 0x08, 0x6d,
	0x61, 0x78, 0x5f, 0x70, 0x6f, 0x64, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x6d,
	0x61, 0x78, 0x50, 0x6f, 0x64, 0x73, 0x22, 0x5f, 0x0a, 0x09, 0x4e, 0x6f, 0x64, 0x65, 0x47, 0x72,
	...
	,
...
var file_controlplane_scenario_proto_goTypes = []interface{}{
	...
	(*events.NodeFailure)(nil),            // 4: apate.controlplane.NodeFailure
	(*events.NetworkSegregation)(nil),     // 5: apate.controlplane.NetworkSegregation
	(*events.NetworkLatency)(nil),         // 6: apate.controlplane.NetworkLatency
	(*events.TimeoutKeepHeartbeat)(nil),   // 7: apate.controlplane.TimeoutKeepHeartbeat
	(*events.NoTimeoutNoHeartbeat)(nil),   // 8: apate.controlplane.NoTimeoutNoHeartbeat
	(*events.LifecycleTimeout)(nil),       // 9: apate.controlplane.LifecycleTimeout
	(*events.LifecycleErrorResponse)(nil), // 10: apate.controlplane.LifecycleErrorResponse
	(*events.ResourcePressure)(nil),       // 11: apate.controlplane.ResourcePressure
	(*events.PodStatusUpdate)(nil),        // 12: apate.controlplane.PodStatusUpdate
	(*events.PodStartTimeUpdate)(nil),     // 13: apate.controlplane.PodStartTimeUpdate
...
var file_controlplane_scenario_proto_depIdxs = []int32{
	...
	4,  // 3: apate.controlplane.Task.node_failure:type_name -> apate.controlplane.NodeFailure
	5,  // 4: apate.controlplane.Task.network_segregation:type_name -> apate.controlplane.NetworkSegregation
	6,  // 5: apate.controlplane.Task.network_latency:type_name -> apate.controlplane.NetworkLatency
	7,  // 6: apate.controlplane.Task.timeout_keep_heartbeat:type_name -> apate.controlplane.TimeoutKeepHeartbeat
	8,  // 7: apate.controlplane.Task.no_timeout_no_heartbeat:type_name -> apate.controlplane.NoTimeoutNoHeartbeat
	9,  // 8: apate.controlplane.Task.node_lifecycle_timeout:type_name -> apate.controlplane.LifecycleTimeout
	10, // 9: apate.controlplane.Task.node_lifecycle_error:type_name -> apate.controlplane.LifecycleErrorResponse
	11, // 10: apate.controlplane.Task.resource_pressure:type_name -> apate.controlplane.ResourcePressure
	9,  // 11: apate.controlplane.Task.pod_lifecycle_timeout:type_name -> apate.controlplane.LifecycleTimeout
	10, // 12: apate.controlplane.Task.pod_lifecycle_error:type_name -> apate.controlplane.LifecycleErrorResponse
	12, // 13: apate.controlplane.Task.pod_status_update:type_name -> apate.controlplane.PodStatusUpdate
	13, // 14: apate.controlplane.Task.pod_start_time_update:type_name -> apate.controlplane.PodStartTimeUpdate
	0,  // 15: apate.controlplane.Scenario.loadScenario:input_type -> apate.controlplane.PublicScenario
	14, // 16: apate.controlplane.Scenario.startScenario:input_type -> google.protobuf.Empty
	14, // 17: apate.controlplane.Scenario.loadScenario:output_type -> google.protobuf.Empty
	14, // 18: apate.controlplane.Scenario.startScenario:output_type -> google.protobuf.Empty
...
func file_controlplane_scenario_proto_init() {
	...
	file_controlplane_scenario_proto_msgTypes[1].OneofWrappers = []interface{}{
		...
		(*Task_NetworkSegregation)(nil),
		(*Task_NetworkLatency)(nil),
		(*Task_TimeoutKeepHeartbeat)(nil),
		(*Task_NoTimeoutNoHeartbeat)(nil),
		(*Task_NodeLifecycleTimeout)(nil),
		(*Task_NodeLifecycleError)(nil),
		(*Task_ResourcePressure)(nil),
		(*Task_PodLifecycleTimeout)(nil),
		(*Task_PodLifecycleError)(nil),
