...
// Copied from https://github.com/kubernetes/kubernetes/blob/master/pkg/kubelet/apis/stats/v1alpha1/types.go
// Changes w.r.t. that version: added `inline` json tags to FsStats and removed UserDefinedMetric.value because controller-gen can't handle float64 values
